        ...
        <section className="complaint-form-card">
          <div className="complaint-heading">
            ...
            <div>
              ...
              <p>
                Share what happened. Your identity is protected and your report
                helps build a safer campus for everyone.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="complaint-options">
              ...
              <div className="upload-box">
                <div>
                  <h4>Upload Evidence <span>(Optional)</span></h4>
                  <p>Add photos, videos or documents to support your report.</p>
                </div>
